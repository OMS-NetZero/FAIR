...
project = u'FaIR'
copyright = u'2019, FaIR development team'
...
vlist = fair.__version__.split('.')
vX = vlist[0]
vY = vlist[1]
version = vX + '.' + vY
# The full version, including alpha/beta/rc tags.
release = fair.__version__
...
latex_documents = [
    (master_doc, 'FaIR.tex', u'FaIR Documentation',
     u'FaIR development team', 'manual'),
]
...
man_pages = [
    (master_doc, 'fair', u'FaIR Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FaIR', u'FaIR Documentation',
     author, 'FaIR', 'One line description of project.',
     'Miscellaneous'),
]
